...
References:
  - every ADR/UC/SPIKE/TASK/OQ/QS/DRV/track/epic-* mention in scanned files
...
REF_RE = re.compile(r"\b(?:ADR|UC|SPIKE|TASK|OQ|QS|DRV|track|epic)-[a-z0-9][a-z0-9-]*[a-z0-9]\b")
QS_DEF_RE = re.compile(r"^\|\s*((?:QS|DRV|track)-[a-z0-9][a-z0-9-]*[a-z0-9])\s*\|")
